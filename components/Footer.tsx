...
const Footer = () => {
	return (
		<footer>
			<div className='relative -z-20 bg-footerMobile bg-cover bg-no-repeat md:bg-footerTablet lg:bg-footerDesktop'>
				<div className='absolute inset-0 -z-10 h-full w-full bg-steelBlue opacity-90' />
				<div className='flex flex-col items-center gap-6 px-6 py-24 text-center text-offWhite md:gap-8 md:px-24 md:py-16 lg:flex-row lg:justify-around lg:gap-0 lg:px-40 lg:py-28 lg:text-left'>
